...
const CalculadoraMotos = () => {
  ...
  return (
    <div className="calculadora-motos max-w-3xl mx-auto p-8 bg-white border border-gray-200 rounded-xl my-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-7">
        <div className="space-y-5">
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-14 pr-4 py-3 bg-white border border-gray-300 rounded-lg text-lg font-medium text-gray-800 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                placeholder="0,00"
                required
              />
          ...
          <div className={`p-4 border rounded-lg hover:bg-gray-50 cursor-pointer transition-all duration-200 ${taxaAlienacao ? 'bg-orange-50 border-orange-400' : ''}`}>
            <label className="flex items-center cursor-pointer">
              ...
              />
              <span className="ml-3 text-gray-700 font-medium">Incluir Taxa de Alienação <span className="text-orange-700">(R$ {VALOR_TAXA_ALIENACAO.toLocaleString('pt-BR', { minimumFractionDigits: 2 })})</span></span>
            </label>
          </div>
        </div>
        ...
        <div className="border rounded-lg p-5 bg-orange-50 space-y-4">
          <div>
          ...
          <div className="border-t border-gray-200 pt-5">
            <div className="flex justify-between items-center bg-orange-700 p-4 rounded-lg text-white">
        ...
        <button
          type="submit"
          className="w-full bg-orange-700 text-white py-4 px-6 rounded-lg hover:bg-orange-800 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 transition-all duration-300 flex items-center justify-center font-semibold text-lg"
        >
